...
Route::get('/former-teachers-staffs', FormerTeacherStaffsPageComponent::class)->name('former-teachers-staffs-page');
Route::get('/teachers-staffs', TeachersPageComponent::class)->name('teachers-staffs-page');
