...
Route::get('/committees', InstitutionalCommitteePageComponent::class)->name('committees');
Route::get('/academic-classes', AcademicClassesPageComponent::class)->name('academic-classes');
