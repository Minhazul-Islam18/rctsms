                ...
                <div class="card-body">
                    <form class="row g-3" wire:submit='SaveGeneralSettings'>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    @elseif ($settings['site_logo'] != null)
                                        <img class="w-25 mb-2" src="{{ asset('storage') }}/{{ $settings['site_logo'] }}"
                                            alt="">
                                    @endif
                                ...
                                <div class="col-6">
                                    ...
                                    @elseif ($settings['favicon'] != null)
                                        <img class="w-25 mb-2" src="{{ asset('storage') }}/{{ $settings['favicon'] }}"
                                            alt="">
                                    @endif
                                    <div class="py-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="" wire:model='settings.meta_title'
                                required>
                        </div>
                        <div class="col-md-6">
