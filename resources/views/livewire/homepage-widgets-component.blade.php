                    ...
                    @foreach ($widgets as $widget)
                        <div class="d-flex justify-content-between align-item-center py-2 border-bottom">
                            ...
                            <div class="d-flex flex-row align-items-center justify-content-end gap-2">
                                ...
                                <button class="btn btn-danger btn-sm" wire:click="confirmDelete({{ $widget->id }})">
                            ...
                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button wire:click="cancelDeleteWidget" type="button" class="btn btn-secondary"
                    ...
                    <form wire:submit="{{ $editing == true ? 'updateWidget' : 'createWidget' }}">
                        <div class="row">
                            <div class="col-3">
                                ...
                                @if ($image)
                                    <img src="{{ $image->temporaryUrl() }}" alt="" class="rounded-1 w-100 mb-1">
                                @elseif ($imageName)
                                    <img src="/storage/{{ $imageName }}" alt="" class="rounded-1 w-100 mb-1">
                                @endif
                            </div>
