                ...
                <div class="col-md-6 col-sm-12 col-12">
                    <div class="image-box">
                        <div class="row g-0">
                            ...
                            <div class="col-md-4 col-sm-12 col-12">
                                <svg fill="#000000" height="auto" width="100%" version="1.1" id="Capa_1"
                                    xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                    viewBox="0 0 406.846 406.846" xml:space="preserve">
                                    <path
                ...
                @foreach ($individual as $item)
                    <div class="card mb-md-3 mb-sm-2 mb-2" wire:key='{{ $item->index }}'>
                        ...
                        <div class="card-footer d-flex justify-content-center">
                            <a href="{{ route('person-page', ['id' => $item->id]) }}" class="btn btn-info btn-sm">
                                {{ __('আরো পড়ুন') }}
                            </a>
                        </div>
                    </div>
